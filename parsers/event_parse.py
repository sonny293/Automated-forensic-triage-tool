...
def path_find():
    try:    
        ...
        # Go up one level from parsers/ into results/
        ...
        return evtx_path, report_output_path, attempts_output_path
...
def file_parser(evtx_path, attempts_output_path):
    ...
    try:    
        ...
        try:
            ...
            print(f'File Missing or Corrupt:{file_error}')
        except Exception as error:
            print(f'Error occured:{error}')
    except:
        print('')
...
def write_json_report(raw_events, risky_ips, risk_threshold, 
                    time_window_minutes, execution_duration_seconds,
                    report_output_path):
    """
